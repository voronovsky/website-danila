...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 06 2026 г., 18:55
...
-- База данных: `demm_db`
--
CREATE DATABASE IF NOT EXISTS `demm_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `demm_db`;
...
(84, 1, 'Собирается', '2026-03-26 17:01:24', '2026-03-26 17:01:24');
...
INSERT INTO `products` (`id`, `name`, `article`, `collection`, `category`, `quantity`, `price`, `sale_price`, `created_at`) VALUES
(1, 'Demm Rory Смеситель для биде на 1 отв. с донным клапаном, цвет: бронза', '4720X', 'ERYOS', 'Смеситель', 15, 5460.00, NULL, '2026-03-22 11:21:12'),
(2, 'Demm Rory Смеситель для раковины встраиваемый, с внутренней частью, излив 18 см, цвет: хром-золото', '4720asd', 'ELITE', 'Смеситель', 7, 3280.00, 1250.00, '2026-03-22 11:21:59'),
(3, 'Demm Rory душевая система', 'ABCDE1', 'ALKES', 'Душевые системы', 3, 8600.00, NULL, '2026-03-22 11:22:50');
...
INSERT INTO `users` (`id`, `login`, `password`, `full_name`, `created_at`) VALUES
(1, 'test_login', 'test_password', 'Иванов Иван Иванович', '2026-03-21 11:41:48');
...
('root', '[{\"db\":\"demm_db\",\"table\":\"users\"},{\"db\":\"demm_db\",\"table\":\"manufacturer\"},{\"db\":\"demm_db\",\"table\":\"collection\"},{\"db\":\"demm_db\",\"table\":\"products\"},{\"db\":\"demm_db\",\"table\":\"categories\"},{\"db\":\"demm_db\",\"table\":\"order_items\"},{\"db\":\"demm_db\",\"table\":\"orders\"}]');
...
('demm_db', 'collection', 'name'),
('demm_db', 'products', 'article');
...
('root', '2026-03-21 11:40:30', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ru\"}');
